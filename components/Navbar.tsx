        ...
        <header id="header" className="overflow-hidden text-white body-font bg-gradient-to-r from-[#19142a] via-[#100d26] to-[#100D26]">
            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <Link className="flex title-font font-medium items-center text-white mb-4 md:mb-0" href="/">
                    <span className="ml-6 text-2xl tracking-widest  font-bold hover:text-purple-500 flex items-center gap-1">
                        <Image width={24} height={24} alt='czar logo' className="  rounded-full" src="/czar.png" />
                            CZAR</span>
                </Link>
