...
<div className="flex md:h-full pt-24 md:pt-0  items-center  justify-center">
  <div className="md:px-20 px-14 py-6 shadow-xl bg-[#251E3E] md:w-[50vw] lg:w-[30vw] sm:scale-110 md:scale-125" style={{ borderRadius: 10 }}>
    <div className="text-center py-4">
        <h1 className='text-center text-[32px]  font-bold text-white'>Log-in</h1>
    </div>
    <form action="post" className='mt-4 w-full' >
            <div className='flex justify-center flex-col w-full'>
                ...
                <button className='border mt-8 bg-indigo-600 text-white py-2 rounded-full border-slate-800 uppercase'> Log-in </button>
            </div>
               <div className='text-center'>
               <Link href="/signin/register" className='text-blue-700 text-sm mt-2'>create account </Link>
               </div>
        </form>
  </div>
</div>
